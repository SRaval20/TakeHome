...
export default function Home() {
  ...
  */
  ...
  const categoryParam = searchParams.get("category"); // Get the value of the 'category' parameter from the URL
  const searchParam = searchParams.get("search"); // Get the value of the 'search' parameter from the URL
  ...
  useEffect(() => {
    ...
    */
    if (categoryParam) {
      ...
      setCategory(null);
      console.log("not category param");
    }
